  ...
  <div>
    ...
    <form class="form" v-else @submit.prevent="handleSubmit">
      ...
      <div class="input-field">
        ...
        <span class="helper-text invalid" v-if="$v.amount.$dirty && !$v.amount.minValue">Минимальная значение {{$v.amount.$params.minValue.min}}</span>
      </div>

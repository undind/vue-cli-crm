<template>
  <form class="card auth-card" type="submit" @submit.prevent="submitHandler">
    <div class="card-content">
      ...
      <div class="input-field">
        ...
        <small class="helper-text invalid" v-else-if="$v.email.$dirty && !$v.email.email">Введите кооректный Email</small>
      </div>
      <div class="input-field">
        ...
        <small class="helper-text invalid" v-else-if="$v.password.$dirty && !$v.password.minLength">Пароль должен быть длинне {{$v.password.$params.minLength.min}} символов</small>
      </div>
    </div>
